...
#
# Script generated by Vivado on Tue Dec 19 18:42:07 +0900 2023
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/works/verilog/kong/hdmi/hdmi_test/project/project.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
